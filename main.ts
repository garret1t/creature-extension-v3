...
controller.B.onEvent(ControllerButtonEvent.Repeated, function () {
    controller.moveSprite(creatures.getTrainerSprite(myTrainer), 120, 120)
    characterAnimations.loopFrames(
    creatures.getTrainerSprite(myTrainer),
    [img`
        . . . . . . . . . . . . . 
        . . . f f f f f f . . . . 
        . f f f f f f f f f . . . 
...
controller.B.onEvent(ControllerButtonEvent.Released, function () {
    controller.moveSprite(creatures.getTrainerSprite(myTrainer), 80, 80)
    characterAnimations.loopFrames(
    creatures.getTrainerSprite(myTrainer),
    [img`
        . . . . . . . . . . . . . 
...
let route1 = tilemap`level`
let route2 = tilemap`level2`
let route3 = tilemap`level3`
